...
\subsection*{Summary of the PF algorithm}
\noindent\justify
...
\section{$b$-tagged jets}\label{sec:objectsBJets}
\noindent\justify
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.49\textwidth]{images/detector/Figure_031-c.png}\\
