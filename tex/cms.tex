...
\begin{figure}[!htp]
  \centering
   \includegraphics[width=0.95\textwidth]{images/detector/cms_complete_labelled.png}
...
\begin{figure}[!htp]
  \centering
   \includegraphics[width=0.95\textwidth]{images/detector/ECAL.png}
...
\begin{figure}[!htp]
  \centering
   \includegraphics[width=0.95\textwidth]{images/detector/muonsystem.png}
