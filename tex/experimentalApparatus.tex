...
\begin{figure}[!htp]
  \centering
   \includegraphics[width=0.9\textwidth]{images/detector/figs_2011_cmsTracker_TrackerLayout.png}
...
\begin{figure}[!htp]
  \centering
   \includegraphics[width=0.9\textwidth]{images/detector/ECAL.png}
...
\begin{figure}[!htp]
  \centering
   \includegraphics[width=0.8\textwidth]{images/detector/HCAL.png}
...
\begin{figure}[!htp]
  \centering
   \includegraphics[width=0.8\textwidth]{images/detector/muonsystem.png}
