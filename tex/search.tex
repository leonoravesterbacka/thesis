...
The theoretical framework presented in Chapter~\ref{sec:theory} lays the foundation for the search for strong and electroweak production of SUSY particles that this thesis is presenting. 
...
To put this into perspective, there are inclusive searches for strong SUSY prodcution in all hadronic final states that are completely swamped by QCD and W+jets processes. 
...
Since my main contribution to the first paper was in the search for chargino-neutralino production (\firstcharg-\secondchi) and higgsino production, I will dedicate a large fraction of this thesis to a description of this search, and refer to it in the following as the "Electroweak search".
\section{SUSY searches with opposite sign same flavor leptons}
The strong SUSY search, targeting gluino (\gluino) or sbottom (\sbottom) production will also be presented in this thesis, refered to in the following as "Strong search".
...
The slepton search has many similarities to the electroweak search, but has some main differences that needs other SM background prediction techniques. 
...
The strong SUSY searches is the oldest search presented in this thesis, as it has a higher production cross section associated to it that made it relevant already in the Run 1 of the LHC. 
The Electroweak search has a lower cross section associated to it, and many of the scenarios probed are for the first time presented in this paper. 
Lastly, the direct slepton search has the lowest cross section associated to it, making it the latest production mode covered by this final state. 
\subsection{Strong SUSY search}
The strong SUSY search using opposite sign same flavor leptons can target two production modes. 
...
\end{figure}                                                                                                                                          
The second strong SUSY production model that can be targeted using opposite sign same flavor leptons is the direct pair production of \sbottom.
...
\subsection{Electroweak SUSY search}
The SUSY models considered in the first paper assume electroweak production (EW) and Gauge mediated SUSY breaking (GMSB), and are presented in Figure \ref{sig:feynmanEWK}. 
...
\end{figure}                                                                                                                                 
\subsection{Slepton search}
SUSY models predict charged sleptons ($\seL$, $\smuL$, $\stauL$, $\seR$, $\smuR$, $\stauR$), the superpartners of the charged left-handed and right-handed SM leptons. 
...
The large cross section Drell-Yan process (DY), where a virtual photon or a Z boson decays to two leptons, is a major background in the search for Charginos and Neutralinos as a lepton pair compatible with a \PZ boson is required in the final state, and is shown in Fig.~\ref{fig:Feynmandy}. 
